                ...
                while (True):
                    try:
                        ...
                        if current_turn.player.name == 'Opponent':
                            ...
                            d_single_dict = {'1':(1-(1-0.25)**3),'2':(1-(1-0.35)**3),'3':(1-(1-.40)**3),'4':(1-(1-.60)**3)}

                            o_triple_dict = {'1':0.04,'2':0.08,'3':.12,'4':.20}
                            o_double_dict = {'1':0.04,'2':0.08,'3':.12,'4':.20}
                            o_single_dict = {'1':0.25,'2':0.35,'3':.40,'4':.60}
